...
export const recommendations: Recommendation[] = [
  ...
  },
  {
    ...
    recommendation_url:
      "https://www.linkedin.com/in/aliarghyani/details/recommendations/?detailScreenTabIndex=0",
    text:
      "Ali and I collaborated in the telecommunications industry for about five years. During this time, Ali handled multiple roles, adapting quickly and excelling in each due to his dedication, intelligence, and work ethic. Ali’s commitment to his work was one of his most defining qualities. He approached every task with thoroughness, following up consistently to ensure that projects were completed to the highest standard. Even though we weren’t on the same team and company, his collaborative spirit and professionalism made him a standout colleague. I truly enjoyed the opportunity to work with him and am confident he will be an asset in any organization he joins.",
  },
  {
  ...
  },
  {
    ...
    recommendation_url:
      "https://www.linkedin.com/in/aliarghyani/details/recommendations/?detailScreenTabIndex=0",
    text:
      "I’ve worked closely with Ali on several projects over the years, and he’s someone I’ve always been able to count on. He’s a quick learner, a dedicated problem-solver, and brings a positive attitude to every challenge. No matter how tough the situation, Ali is always ready to help and never hesitates to ask questions to get the best result. His friendly, team-first approach has made a real difference in our work together. As he moves into web development, I have no doubt he’ll be successful. His drive to improve, strong analytical skills, and willingness to learn make him well-suited to any field he sets his mind to. I fully recommend Ali and believe he’ll thrive in this new career. Best, Faisal",
  },
  {
    author: "Sami Ali",
